        ...
        for _ in range(v):
            ...
            for k in topKGroups:
                ...
                for ent in entity_list[i]:
                    ...
                    minGammaScore = min(minGammaScore, gammaScore/kn)
            ...
            for i in topGroups:
                ...
                for ent in entity_list[i[1]]:
                    ...
                    for p in peerGroups[i[1]]:
                        entScore += (beta/(n_ele*(n_ele+1))) * relMat[p[1]][ent]
