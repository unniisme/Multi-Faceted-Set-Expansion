...
class Model:
    ...
    def calculate(self, domain, query, n_pg = 5, n_p = 6, score_type = 1, category_score_type = 2, alpha = 0.3, beta = 0.3, gamma = 0.4):
...
##        cat_size = dp.read_size(self.data_path+"categories_score.tsv", group_lists,1)
 ...
 #-------------------------------Beginning of Algorithm-----------------------------------------------
        ...
        thresholds = [[0.5,0.5,0.5,0.5],[0.95, 0.93, 0.92, 0.88]]
        minGroups = 25
        x = 3
        popFactor = 1
        # -------------------
